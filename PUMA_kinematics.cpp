...
extern void print_matrix_4x4(double matrix[][4]);
...
extern void PUMA_kinematics_easy();
void main()
{
...
int PUMA_kinematics(int start, int end, double  result[][4], double theta_1, double theta_2, double theta_3, double theta_4, double theta_5, double theta_6)
{
    ...
    double  T_2to3[4][4] = {
                               {cos(DEGREE2RAD * theta_3)   ,0                              ,-1 * sin(DEGREE2RAD * theta_3)  ,a_3 * cos(DEGREE2RAD * theta_3)                               },
                               {sin(DEGREE2RAD * theta_3)   ,0                              ,cos(DEGREE2RAD * theta_3)       ,a_3 * sin(DEGREE2RAD * theta_3)                               },
                               {0                           ,-1                             ,0                               ,0                               },
                               {0                           ,0                              ,0                               ,1                               } };
